...
import com.gump.netty.MessageType;
import com.gump.netty.heartbeat.struct.Header;
import com.gump.netty.heartbeat.struct.NettyMessage;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg)
        ...
        if (message.getHeader() != null
            ...
            heartBeat = ctx.executor().scheduleAtFixedRate(
                    new HeartBeatReqHandler.HeartBeatTask(ctx), 0, 10000,
