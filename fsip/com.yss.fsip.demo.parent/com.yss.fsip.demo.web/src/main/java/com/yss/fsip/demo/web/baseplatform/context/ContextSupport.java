...
public final class ContextSupport {
	 ...
	 * 用户名称
	 */
	public final static String ATTRIBUTE_NAME_USERNAME = "userName";
	/**
	 * 用户地址
	 */
	public final static String ATTRIBUTE_NAME_ADDRESS = "address";
	/**
	 * 用户工作模式
	 */
	public final static String ATTRIBUTE_NAME_WORKMODE = "workmode";
	/**
	 * 请求ID
	 */
	public final static String ATTRIBUTE_NAME_REQUESTID = "requestid";
	/**
	 * 本地化信息
	 */
	public final static String ATTRIBUTE_NAME_LOCALE = "locale";

	/**
	 * 门户地址
	 */
	public final static String ATTRIBUTE_NAME_PORTALURL = "portalurl";

	/**
	 * 公共资源地址
	 */
	public final static String ATTRIBUTE_NAME_RESOURCES = "resources";
