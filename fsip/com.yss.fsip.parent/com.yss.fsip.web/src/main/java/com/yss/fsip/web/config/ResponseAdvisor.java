	...
	public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
		...
		try{
			if(fsipLogProperties.isResponse()
				...
				rootNode.put(FSIPWebConstants.CONTEXT_KEY_SERIALNO, context.getAttribute("serialNo"));
				rootNode.put("status", ((ServletServerHttpResponse) response).getServletResponse().getStatus());
				rootNode.put("time",  System.currentTimeMillis() - Long.parseLong(context.getAttribute("startTime")));
